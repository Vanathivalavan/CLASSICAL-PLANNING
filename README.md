...
```
# Output:
<img width="231" height="50" alt="image" src="https://github.com/user-attachments/assets/de3ec156-1eb4-4593-95d3-a94e5421e3f1" />

# Result:
Thus, the planning problem was successfully implemented using the Breadth First Search (BFS) strategy. The required sequence of actions to reach the goal state from the initial state was found successfully.
